...
export const TestimonialsSection = () => {
  const testimonials = [
    {
      quote:
        "Agentscape has completely transformed how we build AI features. The components are beautifully designed and incredibly easy to integrate.",
      name: "Alex Rivera",
    ...
    {
      quote:
        "As a solo developer, Agentscape saved me months of work. I was able to add sophisticated AI capabilities to my app in just a few days.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "The documentation is excellent and the component API is so intuitive. This is how all AI libraries should be built.",
      name: "Michael Osei",
