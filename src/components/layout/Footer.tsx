  ...
  const sections = [
    {
      ...
      links: [
        ...
        { label: "GitHub", href: "https://github.com/japborst/agentscape" },
      ],
    },
    {
      title: "Community",
      links: [
        { label: "Twitter", href: "https://www.x.com/japborst" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6">
              Beautiful, accessible, and customizable AI agent components that you can install with
              CLI and drop into your apps.
            </p>
            <div className="flex items-center space-x-3">
              <a
                href="https://www.github.com/japborst/agentscape"
                target="_blank"
